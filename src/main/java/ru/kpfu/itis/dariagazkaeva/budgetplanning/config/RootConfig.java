...
@ComponentScan(basePackages = {"ru.kpfu.itis.dariagazkaeva.budgetplanning.repositories",
        "ru.kpfu.itis.dariagazkaeva.budgetplanning.services"}, excludeFilters = {
        @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = UserService.class)})
@PropertySource("classpath:/application.properties")
public class RootConfig {
    @Resource
    private Environment env;
    private static final String ENTITIES_PACKAGE = "ru.kpfu.itis.dariagazkaeva.budgetplanning.entities";
